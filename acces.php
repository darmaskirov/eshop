...
<div style="
   ...
   /* background: #fc0;  Цвет фона */
        ...
        <img src="assets/files/images/smile2.png" width="200" height="200">
        <br>
    <h1 align="center"><font size="6px">Дякуємо за замовлення, скоро з вами зв'яжеться наш консультант для перевірки даних</font></h1>
        <form action="index.php">
                            <button class="btn btn-warning" type="submit">Повернутись на головну</button>
                        </form>
