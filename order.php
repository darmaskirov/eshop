...
if(isset($_POST['name']) && isset($_POST['surname']) && isset($_POST['phone']) && isset($_POST['adress']) && isset($_POST['goods_id']) && isset($_POST['optionsRadios'])){
    $host = 'localhost';
        $user = 'root';
        $password = 'root';
        $database = 'eshop';
    ...
    $goods_id = htmlentities(mysqli_real_escape_string($link, $_POST['goods_id']));
    $radio = htmlentities(mysqli_real_escape_string($link, $_POST['optionsRadios']));
    // создание строки запроса
    $query ="INSERT INTO orders VALUES(NULL, '$name','$surname','$phone','$adress','$goods_id','$radio')";
       ...
       <form method="POST">
             ...
             <span class="field__label">Номер телефону</span>
                   ...
                   <label class="field field_v5">
                       <input class="field__input" placeholder="адреса" name="goods_id">
                       <span class="field__label-wrap">
